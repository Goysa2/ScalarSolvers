...
include("Bissection/Trouve_Intervalle_Stop.jl")
include("Bissection/Bissect_Stop.jl")
include("Bissection/BissectNwt_Stop.jl")
include("Bissection/BissectSec_Stop.jl")
include("Bissection/BissectSecA_Stop.jl")
include("Bissection/BissectCub_Stop.jl")
